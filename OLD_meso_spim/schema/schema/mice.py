...
class Strain(dj.Lookup):
    ...
    contents = [
        ...
        ["Thy1-jRGECO1a-8.31", "C57BL/6J-Tg(Thy1-jRGECO1a)GP8.31DKim/J", "030526"],
        ...
        ["CamK2a-tTa-TetO-GCamP6s-ReaChR", "inhouse(024742x007004)x024846", "in house"],
        ...
        ["Pvalb-cre-TetO-GCamP6s-ReaChR", "inhouse(024742x012358)x024846", "in house"],
        ["Pvalb-FlpO", "B6.Cg-Pvalbtm4.1(flpo)Hze/J", "022730"],
        ["Pvalb-FlpO-ReaChR", "022730x024846", "in house"],
        ["Pvalb-FlpO-Piezo-cre-ReaChR", "inhouse(027719x024846)x022730", "in house"],
...
class Mouse(dj.Manual):
    ...
    def get_starting_date(self):
        ...
        from . import (
            exp,
        )  # import here because exp relies on table mice, therefore can not
...
class SurgeryImage(dj.Computed):
    ...
    def make(self, key):
        ...
        query = Surgery() & key
        for entry in query.fetch("surgery_type", "surgery_image", as_dict=True):
            ...
            self.insert1(
                dict(
                    **key, surgery_type=entry["surgery_type"], surgery_image=str(fname)
                )
            )
